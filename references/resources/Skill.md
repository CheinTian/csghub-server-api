...
|--------|------|---------|----------|
| GET | `/skills` | Get Visiable skills for current user | [View](../operations/get-skills.md) |
| POST | `/skills` | Create a new skill | [View](../operations/post-skills.md) |
| POST | `/skills/upload_url` | Get skill package upload URL | [View](../operations/post-skills-upload-url.md) |
