...
| POST | `/licenses/verify` | Verify a license | [View](../operations/post-licenses-verify.md) |
| DELETE | `/licenses/{id}` | Delete a license by id | [View](../operations/delete-licenses-id.md) |
