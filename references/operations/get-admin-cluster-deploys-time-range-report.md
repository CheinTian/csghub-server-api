# GET /admin/cluster/deploys/time_range_report

**Resource:** [Cluster](../resources/Cluster.md)
**Get deploys by time range as CSV report**
**Operation ID:** `get--admin-cluster-deploys-time_range_report`

Get deploys by time range and return as CSV file download
