# DELETE /{repo_type}/{namespace}/{name}/authorizations/{subject_type}/{subject_id}

**Resource:** [RepositoryAuthorization](../resources/RepositoryAuthorization.md)
**Remove direct repository authorization**
**Operation ID:** `delete--{repo_type}-{namespace}-{name}-authorizations-{subject_type}-{subject_id}`

Removes a direct grant; removing a missing grant is idempotent.
